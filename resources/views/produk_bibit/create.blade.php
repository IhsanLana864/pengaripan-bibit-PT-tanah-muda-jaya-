...
@section('title', 'Tambah Produk Bibit')
@section('header', 'Tambah Produk Bibit Baru')
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <div class="p-6 lg:p-8">
            ...
            <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
                <div>
                    <h2 class="text-xl font-semibold text-gray-800">Form Tambah Produk Bibit</h2>
                    <p class="text-sm text-gray-500 mt-1">Silakan isi data produk bibit yang diperlukan</p>
                </div>
            ...
            <form action="{{ route('produk-bibit.store') }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="Harga_Beli" id="Harga_Beli"
                                ...
                                value="{{ old('Harga_Beli') }}" required min="0" step="0.01">
                        </div>
                        @error('Harga_Beli')
                            <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="Harga_Jual" id="Harga_Jual"
                                ...
                                value="{{ old('Harga_Jual') }}" required min="0" step="0.01">
                        </div>
                        @error('Harga_Jual')
                            <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                        @enderror
